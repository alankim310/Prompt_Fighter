...
export const STAGES: Stage[] = [
  {
    ...
    description:
      "The bridge into the border town was shattered during the final evacuation. Smoke and ash roll across the span as frightened villagers keep rushing over cracked stone and sagging supports. Many of them were once the town's carpenters and builders, and they still know how to brace a failing bridge if someone can steady the panic, direct their efforts, or protect them long enough to work.",
    objective: "Cross the bridge safely.",
    solutionDirections: [
      "Calm the villagers and stop the panicked rush",
      "Organize the carpenters into a controlled repair effort",
      "Protect the workers while they brace the weak supports",
      "Reinforce the bridge yourself with tools, strength, or magic",
      "Create a safer crossing path with planks, bindings, or temporary structures",
      "Stabilize the span just long enough for an orderly crossing",
    ],
    promptIdeas: [
      "Shout clear orders that turn the fleeing carpenters into a repair crew",
      "Shield villagers from falling debris while they brace the supports",
      "Create temporary planks, ropes, or bindings for the villagers to use",
      "Direct everyone into a calm, controlled crossing instead of a stampede",
      "Hold the structure steady yourself while the townsfolk secure it",
    ],
    failureState:
      "The bridge collapses during the crossing, sending everyone into the ravine and restarting the chapter.",
    backgroundImage: getSingleModeSubstoryBackgroundUrl(1),
    enemyOrChallenge:
      "A collapsing evacuation bridge that can only be crossed safely by managing panic and using the villagers' skills",
    encounterImages: [getSinglePlayCharacterImageUrl("fleeing_npcs")],
    artifactImage: CHAPTER_ARTIFACT_IMAGES[1],
    difficulty: 2,
    systemPromptContext:
      "This is an obstacle encounter about crisis leadership, stabilization, and creative traversal under pressure. The bridge is too damaged to trust on its own, and the villagers are a core part of the problem space, not background flavor. Reward solutions that calm panic, organize the carpenters and builders, protect them while they work, reinforce the bridge, create a safer crossing path, or use magic to stabilize the structure long enough to cross. Do not require one exact method. The strongest responses recognize that earning cooperation and directing skilled civilians can be as important as personal power.",
  },
  {
    id: "s1-stage2",
    substoryId: 1,
